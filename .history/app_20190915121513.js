...
const polishWords = ['powyżej / nad / u góry', 'przez coś, akt / czyn / działanie', 'przed', 'wzdłuż', 'między / pośród', 'ilość', 'jakikolwiek', 'nikt', 'pojawić się', 'podejście', 'herb/uzbrojony', 'wokół / dookoła / w pobliżu', 'sztuka', 'jako/ tak jak', 'atak', 'próba', 'sierpień', 'jesień', 'od /daleko / z dala / z daleka', 'podstawa', 'niedźwiedź', 'zostać', ;, początek, za / z tyłu, wierzyć, należeć, poniżej, „poza, za (czymś), po drugiej stronie (czegoś), dalej”, ‘projekt ustawy, rachunek’, kawałek, klocek, krew, cios / dmuchać / wiać, deska, dolny, oddział / gałąź / rozgałęzienie, most, jasny, budynek, oparzenie, stolica, nieść, przypadek / walizka, przyczyna / powód, centralny / środkowy, środek, wiek, pewny, rzeczywiście / z pewnością / na pewno, roszczenie, sierść/powlekać/płaszcz/okrywać cienką warstwą, pospolity, cały / całkowity / pełny, troska, warunek, rozważać, kontynuować, kontrola, róg / narożnik, liczba/liczyć się]
